...
import com.demo.commons.errors.exceptions.NoSuchRestClientErrorExtractorException;
import com.demo.commons.errors.exceptions.RestClientException;
  ...
  public Mono<RestClientException> handleError(ClientResponse clientResponse,
    ...
    return clientResponse
        ...
        .flatMap(codeAndMessage -> {
          ...
          ErrorOrigin selectedErrorOrigin = RestClientErrorSelector.selectType(errorWrapperClass);
